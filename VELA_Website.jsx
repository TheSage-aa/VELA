...
const STORIES = [
  {
    ...
    content: [
      ...
      { type: "body", text: "If someone at your university is living with HIV, sharing a classroom with them carries no risk whatsoever. What does carry risk is the stigma that makes them feel unsafe, unseen, and unsupported in that classroom. That is the real problem VELA is here to address." },
    ],
  ...
  },
  {
    ...
    content: [
      ...
      { type: "body", text: "This is one of VELA's core advocacy targets: pushing Nigerian universities to train campus health staff on PrEP, integrate it into campus sexual health conversations, and make clear referral pathways available to any student who needs it." },
  ...
  },
  {
    ...
    content: [
      ...
      { type: "callout", text: "Knowing the facts about HIV is not the same as treating HIV positive people with dignity. VELA exists in that gap." },
      { type: "body", text: "This is why VELA's approach centres advocacy and community, not just information. The status neutral approach, which removes the separation between HIV positive and negative in how we deliver education and services, is specifically designed to address the social roots of stigma rather than just its informational causes." },
    ],
  ...
  },
  {
    ...
    content: [
      ...
      { type: "body", text: "If you are experiencing discrimination at your university based on your HIV status, reach out to VELA through our anonymous contact option. We can help you understand your options and connect you with support." },
    ],
  ...
  },
  {
    ...
    excerpt: "Receiving a diagnosis during the high-pressure environment of early university life is uniquely challenging. This piece, written with VELA community members, maps what that journey can look like.",
    date: "June 2026",
    readTime: "9 min read",
    content: [
      { type: "lead", text: "This piece was written with members of the VELA community who received their HIV diagnosis during university. Their experiences are their own. We share them here with gratitude and with their permission. If you are currently navigating a new diagnosis, this is for you." },
  ...
  },
  {
    ...
    content: [
      ...
      { type: "body", text: "U=U awareness among Nigerian university students is very close to zero. This means that students living with HIV who are on treatment and undetectable are still being treated as though they pose a transmission risk. This is both scientifically incorrect and deeply unfair. Spreading U=U awareness is one of the most direct ways to reduce HIV stigma on campuses. VELA is committed to making U=U common knowledge in every Nigerian university." },
    ],
...
const Logo = ({ color = "#F7F3EC", size = 32 }) => (
  <svg width={size * 2.2} height={size} viewBox="0 0 88 36" fill="none">
    ...
    <text x="0" y="34" fontFamily="'Space Grotesk',sans-serif" fontSize="20" fontWeight="700" fill={color} letterSpacing="4">VELA</text>
  </svg>
);
...
const Nav = ({ t, colorId, setColorId, isDark, setIsDark, page, setPage }) => {
  ...
  const links = [["About", "about"], ["Our Work", "work"], ["Resources", "resources"], ["Get Involved", "involve"]];
    ...
    <>
      <nav style={{ background: t.navBg, padding: "0 32px", height: 68, display: "flex", alignItems: "center", justifyContent: "space-between", position: "sticky", top: 0, zIndex: 100, transition: "background 0.3s", borderBottom: "1px solid rgba(255,255,255,0.07)" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          ...
          <button onClick={() => setPage("involve")} style={{ background: t.ivory, color: t.primary, border: "none", padding: "9px 20px", borderRadius: 100, fontSize: 13, fontWeight: 700, fontFamily: "'Space Grotesk',sans-serif", cursor: "pointer", letterSpacing: "0.5px", whiteSpace: "nowrap" }}>Join VELA</button>
      ...
      {menuOpen && (
        <div style={{ position: "fixed", inset: 0, background: t.navBg, zIndex: 200, display: "flex", flexDirection: "column", padding: 32, overflowY: "auto" }}>
          ...
          <button onClick={() => { setPage("involve"); setMenuOpen(false); }} style={{ marginTop: 32, background: t.ivory, color: t.primary, border: "none", padding: "16px 32px", borderRadius: 100, fontSize: 16, fontWeight: 700, fontFamily: "'Space Grotesk',sans-serif", cursor: "pointer" }}>Join VELA</button>
        </div>
      )}
    </>
  );
    ...
    <footer style={{ background: t.footerBg, padding: "64px 32px 32px" }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(180px,1fr))", gap: 48, marginBottom: 48 }}>
          ...
          {col("Navigate", [["About VELA", () => setPage("about")], ["Our Work", () => setPage("work")], ["Campus Truth Series", () => setPage("truth")], ["The Peer Circle", () => setPage("circle")], ["Advocacy", () => setPage("advocacy")], ["Resources", () => setPage("resources")]])}
          {col("Get Involved", [["Join The Peer Circle", () => setPage("circle")], ["Become an Ambassador", () => setPage("involve")], ["Volunteer", () => setPage("involve")], ["Partner with VELA", () => setPage("contact")]])}
          {col("Connect", [["Instagram", () => window.open("https://instagram.com/velang", "_blank")], ["X (Twitter)", () => window.open("https://twitter.com/velang", "_blank")], ["LinkedIn", () => window.open("https://linkedin.com/company/velang", "_blank")], ["hello@vela.org.ng", () => window.location.href = "mailto:hello@vela.org.ng"]])}
        </div>
        <div style={{ borderTop: "1px solid rgba(247,243,236,0.1)", paddingTop: 24, display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 12 }}>
          <span style={{ color: "rgba(247,243,236,0.4)", fontSize: 12, fontFamily: "'DM Sans',sans-serif" }}>© 2026 VELA. A youth-led digital organisation registered in Nigeria.</span>
    ...
    <div>
      <section style={s.hero}>
        ...
        <div style={{ maxWidth: 640, position: "relative", zIndex: 2 }}>
          <Tag t={t} light>For every student, regardless of status</Tag>
          <h1 style={s.h1}>No student should navigate HIV on campus alone.</h1>
          <p style={s.heroSub}>VELA is a youth-led organisation closing HIV information gaps in Nigerian universities, fighting for campus health policy change, and building community for students who need it most.</p>
          <div style={{ display: "flex", gap: 16, flexWrap: "wrap" }}>
            <Btn t={t} variant="light" onClick={() => setPage("about")}>Learn About VELA</Btn>
      ...
      <div style={{ background: t.bg, padding: "48px 32px", borderBottom: `1px solid ${t.borderColor}` }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 2, maxWidth: 900, margin: "0 auto" }}>
          {[["1.4%", "National HIV prevalence in Nigeria", "UNAIDS 2025"], ["0", "Dedicated HIV platforms for Nigerian university students before VELA", "As of June 2026"], ["55%", "of students hold stigmatising attitudes toward PLHIV", "Despite 96% HIV knowledge"]].map(([num, label, src], i) => (
      ...
      <section style={s.section}>
        <div style={s.inner}>
          <SectionLabel t={t}>What VELA Does</SectionLabel>
      ...
      <section style={s.sectionDark}>
        <div style={{ ...s.inner, textAlign: "center" }}>
          ...
          <p style={{ ...s.bodyLight, maxWidth: 640, margin: "0 auto 40px" }}>VELA operates on the status neutral approach: the same information, the same care, and the same community for every student regardless of HIV status.</p>
      ...
      <section style={{ background: t.primary, padding: "80px 32px", textAlign: "center" }}>
        <div style={{ maxWidth: 640, margin: "0 auto" }}>
          ...
          <p style={{ ...s.bodyLight, marginBottom: 40 }}>Whether you are a student, researcher, health worker, or someone with lived HIV experience, VELA has a place for you.</p>
    ...
    <div>
      <div style={s.hero}>
        <div style={s.inner}>
          ...
          <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 18, color: "rgba(247,243,236,0.72)", lineHeight: 1.7, maxWidth: 620, marginTop: 20 }}>VELA was founded in 2026 by Adebare Hammed, a young person living with HIV since childhood, a Computer Science undergraduate at Kwara State University, and a youth advocate who spent years navigating HIV in spaces that were not built for him.</p>
        </div>
      </div>
        ...
        <div style={s.inner}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(300px,1fr))", gap: 64, alignItems: "center" }}>
            <div>
              ...
              <h2 style={s.h2}>The gap VELA fills</h2>
              ...
              <p style={s.body}>VELA does not replicate what NEPWHAN or ANAYD do. We go where they have not gone: directly onto the campus, into the student's digital life, before the crisis arrives.</p>
            </div>
            <div style={{ background: t.primary, borderRadius: 16, padding: "48px 32px", textAlign: "center" }}>
              ...
              <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 16, color: "rgba(247,243,236,0.7)", lineHeight: 1.5, marginTop: 12 }}>Dedicated HIV platforms for Nigerian university students before VELA</p>
      ...
      <section style={s.sectionAlt}>
        <div style={s.inner}>
          ...
          <p style={s.body}>VELA is built on the status neutral approach, a modern HIV framework that puts the person ahead of their HIV status. It means we do not run separate programs for positive and negative students. We build one space, one curriculum, one community.</p>
          <p style={s.body}>Because the divide between positive and negative is exactly where stigma lives, and VELA refuses to replicate it.</p>
        </div>
      </section>
        ...
        <div style={s.inner}>
          ...
          {["For the first time since my diagnosis I talked to someone who actually gets it. Not a doctor. Not a counsellor. Someone my age, on a campus, living the same life.", "I did not even know I had rights as an HIV positive student. The Peer Circle changed that."].map((quote, i) => (
            <div key={i} style={{ background: t.card, border: `1px solid ${t.borderColor}`, borderLeft: `4px solid ${t.accent}`, borderRadius: "0 12px 12px 0", padding: 32, marginBottom: 20 }}>
              ...
              <p style={{ fontFamily: "'Space Grotesk',sans-serif", fontSize: 11, fontWeight: 700, color: t.accent, letterSpacing: "1px", textTransform: "uppercase" }}>VELA Peer Circle Member · Nigerian University Student · Anonymous</p>
            </div>
          ))}
        </div>
      </section>
        ...
        <div style={{ maxWidth: 540, margin: "0 auto" }}>
          ...
          {submitted ? (
            <div style={{ background: "rgba(247,243,236,0.12)", border: "1px solid rgba(247,243,236,0.25)", borderRadius: 12, padding: "24px 28px" }}>
              ...
              <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 15, color: "rgba(247,243,236,0.7)", marginTop: 8, lineHeight: 1.6 }}>We will be in touch within 48 hours. Welcome to VELA.</p>
            </div>
          ) : (
...
const WorkPage = ({ t, setPage }) => {
  const pillars = [
    { num: "01", label: "Inform", title: "Because ignorance is not neutral.", body: "HIV myths do not stay in classrooms. They spread in hostels, lecture halls, and WhatsApp groups. VELA delivers status neutral HIV education built specifically for Nigerian campuses. No separation. Everyone learns together.", programs: ["Campus Truth Series", "The Status Neutral Campus Guide"], page: "truth", dark: false },
    { num: "02", label: "Advocate", title: "Policy does not change by itself.", body: "Nigerian universities have no anti-discrimination policies for students living with HIV. No integration of HIV into campus health services. VELA is changing that, one campus at a time, grounded in evidence.", programs: ["Campus Policy Push", "National Prevention Plan Engagement", "Research to Advocacy Pipeline"], page: "advocacy", dark: true },
    { num: "03", label: "Belong", title: "You should not have to be alone in this.", body: "The Belong pillar is the heart of VELA. A peer-led digital community for university students living with HIV in Nigeria. Safe. Affirming. Anonymous where needed.", programs: ["The Peer Circle", "Voices From Campus"], page: "circle", dark: false },
  ];
  ...
  <div>
    <div style={{ background: t.primary, padding: "120px 32px 80px" }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        ...
        <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 18, color: "rgba(247,243,236,0.7)", lineHeight: 1.7, maxWidth: 580, marginTop: 16 }}>VELA advocates for anti-discrimination policies at Nigerian universities and for youth voices in national HIV prevention frameworks.</p>
      </div>
    </div>
    <section style={{ padding: "80px 32px", background: t.bg }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        ...
        <div style={{ marginTop: 64 }}>
          ...
          <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 17, color: t.textMuted, lineHeight: 1.8, maxWidth: 680 }}>VELA's advocacy is grounded in two ongoing research studies. Our research has found a critical knowledge-attitude paradox: 96.85% of university students demonstrate high HIV knowledge, yet only 55.5% hold positive attitudes toward people living with HIV. Knowledge alone is not enough. Policy change is required.</p>
        </div>
  ...
  <div>
    <div style={{ background: t.primary, padding: "120px 32px 80px" }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        ...
        <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 18, color: "rgba(247,243,236,0.7)", lineHeight: 1.7, maxWidth: 540, marginTop: 16 }}>VELA's resource hub is built specifically for Nigerian university students. No jargon. No gatekeeping.</p>
      </div>
    </div>
    <section style={{ padding: "80px 32px", background: t.bg }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
...
const InvolvePage = ({ t, setPage }) => {
  ...
  const ways = [
    ...
    { title: "Campus Ambassador", body: "Be the first VELA presence on your campus. No prior HIV advocacy experience required.", cta: "Apply as Ambassador", action: null },
    { title: "Volunteer", body: "Content, research, design, translation, social media. Bring a skill to VELA.", cta: "Get In Touch", action: () => setPage("contact") },
    { title: "Partner With VELA", body: "Organisations, research institutions, or campus health programmes that share our values.", cta: "Start a Conversation", action: () => setPage("contact") },
  ];
    ...
    <div>
      <div style={{ background: t.primary, padding: "120px 32px 80px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <h1 style={{ fontFamily: "'Space Grotesk',sans-serif", fontSize: "clamp(36px,5vw,64px)", fontWeight: 800, color: t.ivory, lineHeight: 1.1, marginTop: 16 }}>VELA works because people like you decide to show up.</h1>
        </div>
      </div>
      <section style={{ padding: "80px 32px", background: t.bg }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div id="amb-form" style={{ marginTop: 80 }}>
            ...
            <h2 style={{ fontFamily: "'Space Grotesk',sans-serif", fontSize: "clamp(26px,3.5vw,42px)", fontWeight: 800, color: t.text, marginBottom: 16 }}>Be the first VELA presence on your campus</h2>
            <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 17, color: t.textMuted, lineHeight: 1.8, maxWidth: 640, marginBottom: 40 }}>VELA's Campus Ambassador Programme is looking for undergraduate and postgraduate students across Nigerian universities who want to be the bridge between VELA and their campus community. No prior HIV advocacy experience required.</p>
            {ambSent ? <FormSuccess t={t} message="Application received. We will be in touch within five working days. Thank you." /> : (
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(280px,1fr))", gap: 16, maxWidth: 700 }}>
                ...
                <Textarea t={t} placeholder="Why do you want to be a VELA campus ambassador? (2 to 3 sentences)" value={ambForm.why} onChange={e => setAmbForm({...ambForm, why: e.target.value})} rows={4} />
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(300px,1fr))", gap: 64 }}>
          ...
          <div>
            ...
            <div style={{ marginTop: 40, paddingTop: 32, borderTop: `1px solid ${t.borderColor}` }}>
              ...
              <a href="mailto:hello@vela.org.ng" style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 16, color: t.text, display: "block", marginBottom: 8 }}>hello@vela.org.ng</a>
...
export default function App() {
  ...
  const pages = {
    home:      <HomePage     t={t} setPage={setPage} setStoryId={setStoryId} />,
    about:     <AboutPage    t={t} setPage={setPage} />,
    work:      <WorkPage     t={t} setPage={setPage} />,
    truth:     <TruthPage    t={t} setPage={setPage} setStoryId={setStoryId} />,
    story:     currentStory ? <StoryPage t={t} story={currentStory} setPage={setPage} setStoryId={setStoryId} /> : <TruthPage t={t} setPage={setPage} setStoryId={setStoryId} />,
    circle:    <CirclePage   t={t} setPage={setPage} />,
    advocacy:  <AdvocacyPage t={t} setPage={setPage} />,
    resources: <ResourcesPage t={t} setPage={setPage} />,
    involve:   <InvolvePage  t={t} setPage={setPage} />,
    contact:   <ContactPage  t={t} />,
  };

  const handleSetPage = (p) => { setPage(p); window.scrollTo({ top: 0, behavior: "smooth" }); };
